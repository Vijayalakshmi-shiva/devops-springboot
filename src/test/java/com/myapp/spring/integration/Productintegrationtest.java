...
public void cleanUp() {
	...
	public void testGetProductsById() throws Exception {
	  ...
	  .andExpect(jsonPath("$[1].starrating" , is(4.5)));
		  ...
		  @DisplayName("Test Add New Product") public void testAddNewProduct() throws
		  Exception {
		  ...
		  mockMvc.perform(post("/api/v1/product/finds") // Validate Status should be 200 OKand JSON response received
	...
	@Test
	  @DisplayName("Test All Products /api/v1/products/find/{price}") public void
	  ...
	  .andExpect(jsonPath("$[2].productid" , is(5)))
